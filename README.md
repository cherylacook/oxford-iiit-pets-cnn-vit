...
This project was *completed as part of AIML331* at Te Herenga Waka — Victoria University of Wellington. The course required a minimum accuracy of 45% for the CNN and 35% for the ViT; the final models achieved 79% test accuracy (CNN) and 56% (ViT).
